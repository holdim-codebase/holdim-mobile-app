...
import { Text, View, Alert, ScrollView, Image, ActivityIndicator } from 'react-native'
        ...
        <View>
          <View style={styles.profileInfoWrapper}>
            ...
            <View style={styles.profileInfoTextWrapper}>
              ...
              <Text style={styles.profilePortfolioAmount}>You govern: {portfolio.length} DAOs</Text>
            </View>
          </View>
              ...
              <View key={asset.title} style={styles.assetWrapper}>
                <View style={styles.assetLeft}>
                  ...
                  <View style={styles.assetTextWrapper}>
                    ...
                    <Text style={styles.assetShare}>{+(asset.share * 100).toFixed(6)}% shares</Text>
                  </View>
                </View>
                <View style={styles.assetRight}>
                  <Text style={styles.assetAmount}>{numeral(asset.amount).format('0[.]00')} {asset.symbol}</Text>
                </View>
              </View>
            ))}
          </ScrollView>
